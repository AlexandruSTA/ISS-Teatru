...
public class TeatrusPanouCentralAdministratorFXML extends UnicastRemoteObject implements Initializable,Serializable, ITeatrusObserver {

    @FXML
    public Button btnLogout;
    public Label firstNameLabel1;
    public Label lastNameLabel1;
    public Button manageShowsButton;
    public Button btnAddShow;
    public Button btnEdit;
    public Label lblWelcome;

    public TeatrusPanouCentralAdministratorFXML() throws RemoteException {
    }

    protected TeatrusPanouCentralAdministratorFXML(int port) throws RemoteException {
        super(port);
    }

    protected TeatrusPanouCentralAdministratorFXML(int port, RMIClientSocketFactory csf, RMIServerSocketFactory ssf) throws RemoteException {
        super(port, csf, ssf);
    }

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        firstNameLabel1.setText(StartApp.user.getNume());
        lastNameLabel1.setText(StartApp.user.getPrenume());
    ...
    public void addShow(ActionEvent event) throws TeatrusException, IOException {
        SceneCreator.launchScene("/Teatrus/Teatrus-AdaugareSpectacol.fxml","Teatrus - Adaugare spectacol");
    }
}
